...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
 ...
 InitYr = -40;
  ...
  PhaseDiffusionA.allocate("PhaseDiffusionA");
  PhaseDiffusionJ.allocate("PhaseDiffusionJ");
  PhaseSigmaR.allocate("PhaseSigmaR");
  LastRecDev.allocate("LastRecDev");
  CatchInput.allocate(1,Npop,1,Nfleet,1,Nyear,-2,1,"CatchInput");
  Index.allocate(1,Npop,1,Nyear,-1,2,"Index");
  SpawnAge.allocate(1,Npop,1,Nyear,-3,MaxAge,"SpawnAge");
  FishAgeData.allocate(1,Npop,1,Nfleet,1,Nyear,-4,MaxAge,"FishAgeData");
  M.allocate("M");
 cout << M << endl;
  Mat.allocate(0,MaxAge,"Mat");
  MatProp.allocate(0,MaxAge);
  Wght.allocate(0,MaxAge,"Wght");
  Fec.allocate(0,MaxAge,"Fec");
  S.allocate(1,2,0,MaxAge,"S");
  InitNStart.allocate("InitNStart");
 PhaseAlpha = 2;
 if (SRType==1) PhaseAlpha = -1;
  TestCodeDat.allocate("TestCodeDat");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  LogRbar.allocate(1,Npop,1,"LogRbar");
  SigmaJ.allocate(PhaseDiffusionJ,"SigmaJ");
  SigmaA.allocate(PhaseDiffusionA,"SigmaA");
  Alpha.allocate(1,Npop,PhaseAlpha,"Alpha");
  SigmaR.allocate(0,5,PhaseSigmaR,"SigmaR");
  Rec_dev.allocate(1,Npop,1,LastRecDev,1,"Rec_dev");
  Beta.allocate(1,Npop,"Beta");
  #ifndef NO_AD_INITIALIZE
    Beta.initialize();
  #endif
  N.allocate(1,Npop,InitYr,Nyear+Nproj+1,1,2,0,MaxAge,"N");
  #ifndef NO_AD_INITIALIZE
    N.initialize();
  #endif
  N_check.allocate(1,Npop,InitYr,Nyear+Nproj+1,1,2,0,MaxAge,"N_check");
  #ifndef NO_AD_INITIALIZE
    N_check.initialize();
  #endif
  N1.allocate(1,Npop,1,2,0,MaxAge,"N1");
  #ifndef NO_AD_INITIALIZE
    N1.initialize();
  #endif
  N2.allocate(1,Npop,1,2,0,MaxAge,"N2");
  #ifndef NO_AD_INITIALIZE
    N2.initialize();
  #endif
  N3.allocate(1,Npop,1,2,0,MaxAge,"N3");
  #ifndef NO_AD_INITIALIZE
    N3.initialize();
  #endif
  SSB.allocate(1,Npop,InitYr,Nyear+Nproj+1,"SSB");
  #ifndef NO_AD_INITIALIZE
    SSB.initialize();
  #endif
  SSBP.allocate(1,Npop,InitYr,Nyear+Nproj+1,"SSBP");
  #ifndef NO_AD_INITIALIZE
    SSBP.initialize();
  #endif
  Eggs.allocate(1,Npop,InitYr,Nyear+Nproj+1,"Eggs");
  #ifndef NO_AD_INITIALIZE
    Eggs.initialize();
  #endif
  F.allocate(1,Npop,1,2,InitYr,Nyear+Nproj+1,"F");
  #ifndef NO_AD_INITIALIZE
    F.initialize();
  #endif
  SSBAGE.allocate(1,Npop,InitYr,Nyear+Nproj+1,0,MaxAge,"SSBAGE");
  #ifndef NO_AD_INITIALIZE
    SSBAGE.initialize();
  #endif
  CAgePred.allocate(1,Nfleet,1,Npop,InitYr,Nyear+Nproj,0,MaxAge,"CAgePred");
  #ifndef NO_AD_INITIALIZE
    CAgePred.initialize();
  #endif
  Dist.allocate(1,Npop,1,Npop,"Dist");
  #ifndef NO_AD_INITIALIZE
    Dist.initialize();
  #endif
  DiffuseA.allocate(1,Npop,1,Npop,"DiffuseA");
  #ifndef NO_AD_INITIALIZE
    DiffuseA.initialize();
  #endif
  DiffuseJ.allocate(1,Npop,1,Npop,"DiffuseJ");
  #ifndef NO_AD_INITIALIZE
    DiffuseJ.initialize();
  #endif
  LikeIndex.allocate(1,Npop,"LikeIndex");
  #ifndef NO_AD_INITIALIZE
    LikeIndex.initialize();
  #endif
  LikeSSBAge.allocate(1,Npop,"LikeSSBAge");
  #ifndef NO_AD_INITIALIZE
    LikeSSBAge.initialize();
  #endif
  LikeFishAge.allocate(1,2,1,Npop,"LikeFishAge");
  #ifndef NO_AD_INITIALIZE
    LikeFishAge.initialize();
  #endif
  Rec_Penal.allocate("Rec_Penal");
  #ifndef NO_AD_INITIALIZE
  Rec_Penal.initialize();
  #endif
  Catch_Penal.allocate("Catch_Penal");
  #ifndef NO_AD_INITIALIZE
  Catch_Penal.initialize();
  #endif
  Fproj.allocate("Fproj");
  #ifndef NO_AD_INITIALIZE
  Fproj.initialize();
  #endif
  Quota.allocate(1,Npop,Nyear+1,Nyear+Nproj,"Quota");
  #ifndef NO_AD_INITIALIZE
    Quota.initialize();
  #endif
  SSBO.allocate(1,Npop,InitYr,Nyear+Nproj+1,"SSBO");
  Obj.allocate("Obj");
...
void model_parameters::SetParameters(void)
{
 int Ipop,Jpop;
...
void model_parameters::InitialState(void)
{
...
void model_parameters::ProjectOneYear(void)
{
...
void model_parameters::Project(void)
{
 F.initialize();
...
void model_parameters::OutputStuff(void)
{
